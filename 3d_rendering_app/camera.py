...
class Camera:
    def __init__(self, initial_x=0, initial_y=0, initial_z=0):
        self.move_speed = 0.1
        self.__camera_speed = 2

        self.__camera_pos = np.array([initial_x, initial_y, initial_z], dtype=np.float32)
        self.__target_vec = np.array([1, 0, 0], dtype=np.float32)  # points towards positive z-axis
    ...
    def move_forward(self):
        ...
        self.__camera_pos += self.__target_vec * self.move_speed
    ...
    def move_left(self):
        ...
        self.__camera_pos += left_vec * self.move_speed
    ...
    def move_up(self):
        self.__camera_pos += self.__up_vec * self.move_speed

    def move_down(self):
        self.__camera_pos -= self.__up_vec * self.move_speed

    def rotate_left(self):
        self.__target_vec = Transform().add_rotation_y(-self.__camera_speed).mult_vec3_from_right(self.__target_vec)

    def rotate_right(self):
        self.__target_vec = Transform().add_rotation_y(self.__camera_speed).mult_vec3_from_right(self.__target_vec)

    def rotate_up(self):
        self.__target_vec = Transform().add_rotation_x(-self.__camera_speed).mult_vec3_from_right(self.__target_vec)
